...
function criaCanos(){
    ...
    let cano6 = new Cano(1900, 350, 80, 150,"#00FF00");
	let cano7 = new Cano(1000, 150, 150, 80,"#00FF00");
...
function Mario(){
	...
	this.vy += g;
		...
		if(Math.abs(this.vx)<=0.061){
         this.vx = 0;   //tirar o atrito "residual" B=====D~~~~~~
